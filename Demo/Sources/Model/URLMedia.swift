...
enum URLMedia {
    static let onDemandVideoHLS = Media(
        ...
        subtitle: "VOD - HLS",
        imageUrl: "https://img.rts.ch/articles/2024/image/2flaad-28737013.image",
        kind: .url("https://rts-vod-amd.akamaized.net/ww/14970442/4dcba1d3-8cc8-3667-a7d2-b3b92c4243d9/master.m3u8")
    )
    static let shortOnDemandVideoHLS = Media(
        ...
        kind: .url("https://rts-vod-amd.akamaized.net/ww/13317145/f1d49f18-f302-37ce-866c-1c1c9b76a824/master.m3u8")
    )
    static let onDemandVideoMP4 = Media(
        ...
        kind: .url("https://cdn.prod.swi-services.ch/video-projects/94f5f5d1-5d53-4336-afda-9198462c45d9/localised-videos/ENG/renditions/ENG.mp4")
    )
    static let dvrVideoHLS = Media(
        ...
        kind: .url("https://visualradio-rts-couleur3-d.akamaized.net/out/v1/lsvs/visual-radio-rts-couleur-3/cmaf/hls-master.m3u8")
    )
    static let liveTimestampVideoHLS = Media(
        ...
        kind: .url("https://tagesschau.akamaized.net/hls/live/2020115/tagesschau/tagesschau_1/master.m3u8")
    )
    static let onDemandAudioMP3 = Media(
        title: "On en parle",
        subtitle: "AOD - MP3",
        imageUrl: "https://www.rts.ch/2023/09/28/17/49/11872957.image?w=624&h=351",
        kind: .url("https://rts-aod-dd.akamaized.net/ww/13306839/63cc2653-8305-3894-a448-108810b553ef.mp3")
    )
    static let liveAudioMP3 = Media(
        ...
        kind: .url("http://stream.srg-ssr.ch/m/couleur3/mp3_128")
    )
    ...
    static let timeRangesVideo = Media(
        ...
        kind: .url("https://rts-vod-amd.akamaized.net/ch/10004745/c0547249-1328-308d-a392-47e0b86968bb/master.m3u8"),
        timeRanges: [
    ...
    static let appleBasic_4_3_HLS = Media(
        ...
        imageUrl: kAppleImageUrl,
        kind: .url("https://devstreaming-cdn.apple.com/videos/streaming/examples/bipbop_4x3/bipbop_4x3_variant.m3u8")
    )
    ...
    static let appleAdvanced_16_9_TS_HLS = Media(
        ...
        imageUrl: kAppleImageUrl,
        kind: .url("https://devstreaming-cdn.apple.com/videos/streaming/examples/img_bipbop_adv_example_ts/master.m3u8")
    )
    static let appleAdvanced_16_9_fMP4_HLS = Media(
        ...
        imageUrl: kAppleImageUrl,
        kind: .url("https://devstreaming-cdn.apple.com/videos/streaming/examples/img_bipbop_adv_example_fmp4/master.m3u8")
    )
    static let appleAdvanced_16_9_HEVC_h264_HLS = Media(
        ...
        imageUrl: kAppleImageUrl,
        kind: .url("https://devstreaming-cdn.apple.com/videos/streaming/examples/bipbop_adv_example_hevc/master.m3u8")
    )
    static let appleWWDCKeynote2023 = Media(
        ...
        kind: .url("https://events-delivery.apple.com/0105cftwpxxsfrpdwklppzjhjocakrsk/m3u8/vod_index-PQsoJoECcKHTYzphNkXohHsQWACugmET.m3u8")
    )
    static let appleDolbyAtmos = Media(
        ...
        kind: .url("https://devstreaming-cdn.apple.com/videos/streaming/examples/adv_dv_atmos/main.m3u8")
    )
    static let appleTvMorningShowSeason1Trailer = Media(
        ...
        kind: .url("https://play-edge.itunes.apple.com/WebObjects/MZPlayLocal.woa/hls/subscription/playlist.m3u8?cc=CH&svcId=tvs.vds.4021&a=1522121579&isExternal=true&brandId=tvs.sbd.4000&id=518077009&l=en-GB&aec=UHD")
    )
    ...
    static let appleTvTrailerInterstitial = Media(
        title: "Apple TV Trailer Interstitial stream",
        subtitle: "AVC and HEVC primary with Bip bop streams as Interstitials",
        imageUrl: kAppleImageUrl,
        kind: .url("https://devstreaming-cdn.apple.com/videos/streaming/examples/interstitial-sample/mvp_interstitial_sample.m3u8")
    )
    static let uhdVideoHLS = Media(
        ...
        kind: .url("https://sample.vodobox.net/skate_phantom_flex_4k/skate_phantom_flex_4k.m3u8")
    )
    static let onDemandVideoLocalHLS = Media(
        title: "Test video pattern",
        subtitle: "Stream served locally",
        kind: .url("http://localhost:8123/simple/on_demand/master.m3u8")
    )
    static let unknown = Media(
        title: "Unknown URL",
        subtitle: "Content that does not exist",
        kind: .url("http://localhost:8123/simple/unavailable/master.m3u8")
    )
    static let unavailableMp3 = Media(
        title: "Unavailable MP3",
        subtitle: "MP3 that does not exist",
        kind: .url("http://localhost:8123/simple/unavailable.mp3")
    )
    static let unauthorized = Media(
        title: "Unauthorized URL",
        subtitle: "Content which cannot be accessed",
        kind: .url("https://httpbin.org/status/403")
    )
    static let unifiedStreamingOnDemand_fMP4 = Media(
        title: "Fragmented MP4",
        imageUrl: kUnifiedStreamingImageUrl1,
        kind: .url("https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8")
    )
    static let unifiedStreamingOnDemandKeyRotation = Media(
        title: "Key Rotation",
        imageUrl: kUnifiedStreamingImageUrl2,
        kind: .url("https://demo.unified-streaming.com/k8s/keyrotation/stable/keyrotation/keyrotation.isml/.m3u8")
    )
    static let unifiedStreamingOnDemandAlternateAudio = Media(
        title: "Alternate audio language",
        imageUrl: kUnifiedStreamingImageUrl1,
        kind: .url("https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-multi-lang.ism/.m3u8")
    )
    static let unifiedStreamingOnDemandAudioOnly = Media(
        title: "Audio only",
        imageUrl: kUnifiedStreamingImageUrl1,
        kind: .url("https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-multi-lang.ism/.m3u8?filter=(type!=%22video%22)")
    )
    static let unifiedStreamingOnDemandTrickplay = Media(
        title: "Trickplay",
        imageUrl: kUnifiedStreamingImageUrl1,
        kind: .url("https://demo.unified-streaming.com/k8s/features/stable/no-handler-origin/tears-of-steel/tears-of-steel-trickplay.m3u8")
    )
    static let unifiedStreamingOnDemandLimitedBandwidth = Media(
        title: "Limiting bandwidth use",
        imageUrl: kUnifiedStreamingImageUrl1,
        kind: .url("https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8?max_bitrate=800000")
    )
    static let unifiedStreamingOnDemandDynamicTrackSelection = Media(
        title: "Dynamic Track Selection",
        imageUrl: kUnifiedStreamingImageUrl1,
        // swiftlint:disable:next line_length
        kind: .url("https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel.ism/.m3u8?filter=%28type%3D%3D%22audio%22%26%26systemBitrate%3C100000%29%7C%7C%28type%3D%3D%22video%22%26%26systemBitrate%3C1024000%29")
    )
    static let unifiedStreamingPureLive = Media(
        title: "Pure live",
        imageUrl: kUnifiedStreamingImageUrl2,
        kind: .url("https://demo.unified-streaming.com/k8s/live/stable/live.isml/.m3u8")
    )
    static let unifiedStreamingTimeshift = Media(
        title: "Timeshift (5 minutes)",
        imageUrl: kUnifiedStreamingImageUrl2,
        kind: .url("https://demo.unified-streaming.com/k8s/live/stable/live.isml/.m3u8?time_shift=300")
    )
    static let unifiedStreamingLiveAudio = Media(
        title: "Live audio",
        imageUrl: kUnifiedStreamingImageUrl2,
        kind: .url("https://demo.unified-streaming.com/k8s/live/stable/live.isml/.m3u8?filter=(type!=%22video%22)")
    )
    static let unifiedStreamingPureLiveScte35 = Media(
        title: "Pure live (scte35)",
        imageUrl: kUnifiedStreamingImageUrl2,
        kind: .url("https://demo.unified-streaming.com/k8s/live/stable/scte35.isml/.m3u8")
    )
    static let unifiedStreamingOnDemand_fMP4_Clear = Media(
        title: "fMP4, clear",
        imageUrl: kUnifiedStreamingImageUrl1,
        kind: .url("https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-fmp4.ism/.m3u8")
    )
    static let unifiedStreamingOnDemand_fMP4_HEVC_4K = Media(
        title: "fMP4, HEVC 4K",
        imageUrl: kUnifiedStreamingImageUrl1,
        kind: .url("https://demo.unified-streaming.com/k8s/features/stable/video/tears-of-steel/tears-of-steel-hevc.ism/.m3u8")
    )
    static let bbcTestCard_Audio_Video_AVC = Media(
        title: "Audio and AVC video",
        subtitle: "All representations in all languages",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-full.m3u8")
    )
    static let bbcTestCard_Audio_Video_AVC_TVs = Media(
        title: "Audio and AVC video",
        subtitle: "Representations for Connected TVs in all languages",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-ctv.m3u8")
    )
    static let bbcTestCard_Audio_Video_AVC_Mobile = Media(
        title: "Audio and AVC video",
        subtitle: "Representations for Mobile Devices in all languages",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-mobile.m3u8")
    )
    static let bbcTestCard_Audio_Video_HEVC_TVs = Media(
        title: "Audio and HEVC video",
        subtitle: "Representations for Connected TVs in all languages",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/hevc-ctv.m3u8")
    )
    static let bbcTestCard_Audio_HE_LC_AAC_en = Media(
        title: "Audio only",
        subtitle: "HE and LC AAC Stereo in English",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-en.m3u8")
    )
    static let bbcTestCard_Audio_HE_AAC_en = Media(
        title: "Audio only",
        subtitle: "HE-AAC Stereo in English",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-he-en.m3u8")
    )
    static let bbcTestCard_Audio_AAC_LC_en = Media(
        title: "Audio only",
        subtitle: "AAC-LC Stereo in English",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-lc-en.m3u8")
    )
    static let bbcTestCard_Audio_AAC_LC_de = Media(
        title: "Audio only",
        subtitle: "AAC-LC Stereo in German",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-lc-de.m3u8")
    )
    static let bbcTestCard_Audio_AAC_LC_fr = Media(
        title: "Audio only",
        subtitle: "AAC-LC Stereo in French",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-lc-fr.m3u8")
    )
    static let bbcTestCard_Audio_HE_LC_AAC_all = Media(
        title: "Audio only",
        subtitle: "HE and LC AAC Stereo in all languages",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-multilang.m3u8")
    )
    static let bbcTestCard_Audio_AAC_LC_surround_en = Media(
        title: "Audio only",
        subtitle: "AAC-LC Surround (4 active channels) in English",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-surround-en.m3u8")
    )
    static let bbcTestCard_Audio_AAC_LC_surround_de = Media(
        title: "Audio only",
        subtitle: "AAC-LC Surround (4 active channels) in German",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-surround-de.m3u8")
    )
    static let bbcTestCard_Audio_AAC_LC_surround_fr = Media(
        title: "Audio only",
        subtitle: "AAC-LC Surround (4 active channels) in French",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-surround-fr.m3u8")
    )
    static let bbcTestCard_Audio_FLAC_en = Media(
        title: "Audio only",
        subtitle: "FLAC Stereo in English",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/radio-flac-en.m3u8")
    )
    static let bbcTestCard_Restricted_Stereo_TVs = Media(
        ...
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-ctv-stereo-en.m3u8")
    )
    static let bbcTestCard_Restricted_HEVC_Stereo_TVs = Media(
        title: "Restricted manifests",
        subtitle: "Connected TV representations (HEVC) with only stereo audio",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/hevc-ctv-stereo-en.m3u8")
    )
    static let bbcTestCard_Restricted_NoSubtitles_TVs = Media(
        title: "Restricted manifests",
        subtitle: "Connected TV representations with no subtitles",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-ctv-no_subs-en.m3u8")
    )
    static let bbcTestCard_Single_192x108p25_AAC_LC = Media(
        title: "Single representations",
        subtitle: "192x108p25, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-192x108p25-en.m3u8")
    )
    static let bbcTestCard_Single_256x144p25_AAC_LC = Media(
        title: "Single representations",
        subtitle: "256x144p25, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-256x144p25-en.m3u8")
    )
    static let bbcTestCard_Single_384x216p25_AAC_LC = Media(
        title: "Single representations",
        subtitle: "384x216p25, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-384x216p25-en.m3u8")
    )
    static let bbcTestCard_Single_512x288p25_AAC_LC = Media(
        title: "Single representations",
        subtitle: "512x288p25, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-512x288p25-en.m3u8")
    )
    static let bbcTestCard_Single_704x396p25_AAC_LC = Media(
        title: "Single representations",
        subtitle: "704x396p25, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-704x396p25-en.m3u8")
    )
    static let bbcTestCard_Single_704x396p50_AAC_LC = Media(
        title: "Single representations",
        subtitle: "704x396p50, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-704x396p50-en.m3u8")
    )
    static let bbcTestCard_Single_896x504p25_AAC_LC = Media(
        title: "Single representations",
        subtitle: "896x504p25, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-896x504p25-en.m3u8")
    )
    static let bbcTestCard_Single_960x540p50_AAC_LC = Media(
        title: "Single representations",
        subtitle: "960x540p50, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-960x540p50-en.m3u8")
    )
    static let bbcTestCard_Single_1280x720p50_AAC_LC = Media(
        title: "Single representations",
        subtitle: "1280x720p50, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-1280x720p50-en.m3u8")
    )
    static let bbcTestCard_Single_1920x1080p50_AAC_LC = Media(
        title: "Single representations",
        subtitle: "1920x1080p50, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-128kbps-1920x1080p50-en.m3u8")
    )
    static let bbcTestCard_Single_1280x720p50_HE_AAC = Media(
        title: "Single representations",
        subtitle: "1280x720p50, 96kbps HE-AAC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-single-96kbps-1280x720p50-en.m3u8")
    )
    static let bbcTestCard_Single_1280x720p50_HEVC_AAC_LC = Media(
        title: "Single representations",
        subtitle: "1280x720p50 HEVC, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/hevc-single-128kbps-1280x720p50-en.m3u8")
    )
    static let bbcTestCard_Single_1920x1080p50_HEVC_AAC_LC = Media(
        title: "Single representations",
        subtitle: "1920x1080p50 HEVC, 128kbps AAC-LC",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/hevc-single-128kbps-1920x1080p50-en.m3u8")
    )
    static let bbcTestCard_NoTLS_HTTP_TVs = Media(
        ...
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-ctv-en-http.m3u8")
    )
    static let bbcTestCard_NoTLS_Relative_TVs = Media(
        title: "Relative or HTTP only BaseURLs",
        subtitle: "Connected TV representations - using relative paths",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-ctv-en-rel.m3u8")
    )
    static let bbcTestCard_NoTLS_Relative_Mobile = Media(
        title: "Relative or HTTP only BaseURLs",
        subtitle: "Mobile resolutions with relative Base URLs    ",
        kind: .url("https://rdmedia.bbc.co.uk/testcard/simulcast/manifests/avc-mobile-en-rel.m3u8")
    )
    static let mux_LowLatency = Media(
        title: "Low-Latency",
        kind: .url("https://stream.mux.com/v69RSHhFelSm4701snP22dYz2jICy4E4FUyk02rW4gxRM.m3u8")
    )
    static let apple_360 = Media(
        title: "Apple 360°",
        imageUrl: kAppleImageUrl,
        kind: .url("https://devstreaming-cdn.apple.com/videos/streaming/examples/immersive-media/360Lighthouse/mvp.m3u8"),
        viewport: .monoscopic
    )
}
