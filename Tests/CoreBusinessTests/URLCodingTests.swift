...
final class URLCodingTests: XCTestCase {
    ...
    func testDecoding() {
        expect(URLCoding.decodeUrn(from: URL(string: "urn://mediacomposition?urn=urn:srf:video:6440e95f-71c5-4510-a165-f81e9c0dd391")!))
            .to(equal("urn:srf:video:6440e95f-71c5-4510-a165-f81e9c0dd391"))
        expect(URLCoding.decodeUrn(from: URL(string: "urn://mediacomposition?urn=urn%3Asrf%3Avideo%3A6440e95f-71c5-4510-a165-f81e9c0dd391")!))
            .to(equal("urn:srf:video:6440e95f-71c5-4510-a165-f81e9c0dd391"))
        expect(URLCoding.decodeUrn(from: URL(string: "urn://mediacomposition?invalid=urn:srf:video:6440e95f-71c5-4510-a165-f81e9c0dd391")!))
            .to(beNil())
