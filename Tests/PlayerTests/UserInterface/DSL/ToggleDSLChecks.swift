...
private enum ToggleDSLChecks {
    ...
    static func menu() -> MenuContent {
        ...
        Toggle("", subtitle: "", isOn: .constant(true))
        Toggle("", image: UIImage(), isOn: .constant(true))
        Toggle("", subtitle: "", image: UIImage(), isOn: .constant(true))
        Toggle("", image: .checkmark, isOn: .constant(true))
        Toggle("", subtitle: "", image: .checkmark, isOn: .constant(true))
        Toggle("", systemImage: "circle", isOn: .constant(true))
        Toggle("", subtitle: "", systemImage: "circle", isOn: .constant(true))
    }
