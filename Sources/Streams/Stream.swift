...
public extension Stream {
    ...
    static let onDemandWithOptions = Self(
    ...
    static let onDemandWithoutOptions = Self(
    ...
    static let onDemandWithSingleAudibleOption = Self(
    ...
    static let onDemandWithForcedAndUnforcedLegibleOptions = Self(
    ...
    static let onDemandWithManyLegibleAndAudibleOptions = Self(
        url: URL(string: """
...
public extension Stream {
    ...
    static let unavailableMp3 = Self(
        url: URL(string: "http://localhost:8123/unavailable.mp3")!,
        duration: .indefinite
    )

    /// A MP3 live stream.
    static let liveMp3 = Self(
...
public extension Stream {
    /// A downloadable (and playable) file.
    static let download = Self(
        url: URL(string: "http://localhost:8123/downloads/silence.mp3")!,
        duration: .indefinite
    )
