...
public struct ToggleInMenu: MenuBody {
    ...
    public func toMenuElement() -> UIMenuElement {
        UIAction.identifiableAction(title: title, image: image, state: state(isOn: isOn)) { action in
...
public struct ToggleInSection: SectionBody {
    ...
    // swiftlint:disable:next missing_docs
    public func toMenuElement() -> UIMenuElement {
        let action = UIAction.identifiableAction(title: title, image: image) { action in
            isOn.wrappedValue.toggle()
