...
struct AssetContent {
    ...
    func playerItem(reload: Bool = false, configuration: PlayerConfiguration, limits: PlayerLimits, resumePosition: inout Position?) -> AVPlayerItem {
    ...
    private func configure(item: AVPlayerItem, resumePosition: inout Position?) {
